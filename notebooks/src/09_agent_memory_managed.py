...
# What we cover:
#
# 1. Connect to the server (and fail loudly with the `docker run` if it isn't up)
...
# below is a normal `pip install`able package on PyPI. The **server** is GA too, but not
