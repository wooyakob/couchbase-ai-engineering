...
Past this scale, or for pure-similarity workloads with no text-search need, see
[Chapter 14 — Vector Index Architectures](14-vector-index-architectures.md) for the GSI-based
Hyperscale and Composite Vector Index alternatives.
